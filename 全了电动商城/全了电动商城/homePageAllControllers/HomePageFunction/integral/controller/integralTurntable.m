...
#import "integralTurntable.h"
#import <WebKit/WebKit.h>
@interface integralTurntable ()<WKNavigationDelegate>

@end

@implementation integralTurntable
...
- (void)setWebView {
    ...
    NSString * str = @"http://www.all-360.com/tg.php?y=yinreg";
